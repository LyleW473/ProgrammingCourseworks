...
public class CovidData {
    ...
    */
    ...
    public int getGMRValues(String GMRType) 
    {
        if(GMRType.equals("Retail and Recreation"))
        {
            return retailRecreationGMR;
        }
        else if (GMRType.equals("Grocery and Pharmacy"))
        {
            return groceryPharmacyGMR;
        }
        else if(GMRType.equals("Parks"))
        {
            return parksGMR;
        }
        else if(GMRType.equals("Transit"))
        {
            return transitGMR;
        }
        else if(GMRType.equals("Workplaces"))
        {
